$(function () {
    layui.use(['table','laydate', 'util','form'], function () {
        ...
        var init_table = table.render({
            ...
            , method: 'post'
            , url: '/productController/listSale.json'
            ...
            , cols: [[
                ...
                , {field: 'janSaleNum', title: '1月'} //width 支持：数字、百分比和不填写。你还可以通过 minWidth 参数局部定义当前单元格的最小宽度，layui 2.2.1 新增
                , {field: 'febSaleNum', title: '2月'}
                , {field: 'marSaleNum', title: '3月'}
                , {field: 'aprSaleNum', title: '4月'}
                , {field: 'maySaleNum', title: '5月'}
                , {field: 'junSaleNum', title: '6月'}
                , {field: 'julSaleNum', title: '7月'}
                , {field: 'augSaleNum', title: '8月'}
                , {field: 'sepSaleNum', title: '9月'}
                , {field: 'octSaleNum', title: '10月'}
                , {field: 'novSaleNum', title: '11月'}
                , {field: 'decSaleNum', title: '12月'}
